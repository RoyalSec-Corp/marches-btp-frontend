...
function ActivityChart({ autoRefreshMs = 30000 }) {
  ...
  const option = { title: { text: 'Activite des appels d\'offres', left: 'center', textStyle: { fontSize: 16, fontWeight: 'bold', color: '#fff' } }, tooltip: { trigger: 'axis', textStyle: { color: '#fff' }, backgroundColor: 'rgba(0,0,0,0.7)' }, xAxis: { type: 'category', boundaryGap: false, data: chartData.labels, axisLine: { lineStyle: { color: '#fff' } }, axisLabel: { color: '#fff' } }, yAxis: { type: 'value', axisLine: { lineStyle: { color: '#fff' } }, axisLabel: { color: '#fff' }, splitLine: { lineStyle: { color: 'rgba(255,255,255,0.2)' } } }, series: [{ name: 'Appels publies', type: 'line', smooth: true, data: chartData.data, areaStyle: { color: '#3b82f6', opacity: 0.1 }, lineStyle: { color: '#f27024ff' }, symbol: 'circle', symbolSize: 8, label: { show: true, color: '#d78914ff' } }] };
